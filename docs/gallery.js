...
function SiteHeader() {
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement("a", { href: "./gallery.html", className: "nav-link active" }, "Gallery"),
      React.createElement("a", { href: "./order.html", className: "nav-link" }, "Order")
    )
  );
}
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement("a", { href: "./order.html", className: "primary-button" }, "Start Your Order"),
          React.createElement("a", { href: "./index.html", className: "secondary-button" }, "Back Home")
        )
      )
    ),
    React.createElement(

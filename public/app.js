      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement("a", { href: "/gallery", className: "primary-button" }, "Explore Gallery"),
            React.createElement("a", { href: "/order", className: "secondary-button" }, "Place an Order")
          ),
          React.createElement(
            "div",
            { className: "trust-row" },
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement("a", { href: "/gallery", className: "secondary-button" }, "Open Gallery"),
          React.createElement("a", { href: "/order", className: "primary-button" }, "Go to Order Page")
        )
      )
    ),
    React.createElement(
